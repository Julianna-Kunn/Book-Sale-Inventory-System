...
public class MainInterface {
    ...
    public void buyBookButton(ActionEvent event){
        URL fxmlResource = getClass().getResource("10_BuyBooks.fxml");
        
        if (fxmlResource == null){
            logger.severe("FXML resource '10_BuyBooks.fxml' not found");
            return;
        }try{
            ...
            logger.severe("Error loading BuyBooks.fxml: " + e.getMessage());
        }
    }
